...
&& in_array($extension, $allowedExts)) {
    ...
    echo "Return Code: " .$filename . "<br>";
        ...
        if($fid = Article::createMedia($_POST,$extension, $db)){
            extract($_POST);
            move_uploaded_file( $tmp_name, "../media/sound/" . $fid.'.'.$extension);
           ...
           echo "Author: " .  $_POST['author'] . "<br>";
            ...
            echo 'Audio was uploaded successfully</div>';
        }
        else{
            echo '<div class="fg-red">Audio was not uploaded successfully</div>';
        }
    }
