...
<form method="post" action="">
	<fieldset>  
        ...
        <div class="input-control textarea">
        	<textarea id="content" name="content" class="form-control editors" ><?php echo @$article->content; ?></textarea>
		</div>
		<label for="author">Author</label>
		<input id="author" type="text" name="author" value="<?php echo @$article->author; ?>" 
...
<br />
            <div ><a href="index.php">View all Articles</a></div>
